  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link acp add-node-modules-path agent-shell aggressive-indent all-the-icons
                ...
                column-enforce-mode company-anaconda concurrent ctable cython-mode
                dap-mode deferred define-word devdocs diff-hl diminish
                dired-quick-sort disable-mouse doom-themes dotenv-mode
                dracula-theme drag-stuff dumb-jump eat edit-indirect elisp-def
                elisp-demos elisp-slime-nav emmet-mode emr epc esh-help
                ...
                flycheck-pos-tip forge ggtags gh-md git-link git-messenger
                git-modes git-timemachine gitignore-templates golden-ratio
                golden-ratio-scroll-screen google-translate grizzl gruvbox-theme
                helm-ag helm-c-yasnippet helm-cider helm-comint helm-company
                helm-cscope helm-descbinds helm-ls-git helm-lsp helm-make
